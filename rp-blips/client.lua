...
function SetHorseBlip(Horse)
    HorseBlip = Citizen.InvokeNative(0x23f74c2fda6e7c61, -1230993421, Horse)
end


function DrawBlip(BlipType, BlipHash, BlipColour, BlipSprite)
    local Blip = Citizen.InvokeNative(0x554d9d53f696d002, BlipType, BlipHash, BlipColour, 0.0
    SetBlipSprite(Blip, BlipSprite, 1)
end