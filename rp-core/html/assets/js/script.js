$(document).ready(function(){
    ...
    $("#form-create").submit(function(event){
        ...
        loading_menu();
        $.post('http://rp-core/Create.Character', JSON.stringify({
            first_name: $("#form-create #create-input-forename").val(),
            last_name: $("#form-create #create-input-surname").val(),
            dob: $("#form-create #create-input-dob").val(),
            sex: $("#form-create #create-select-gender option:selected").val(),
        }));
    });
    ...
    $("#form-edit").submit(function(event){
        event.preventDefault();
        loading_menu();
        $.post('http://rp-core/Edit.Character', JSON.stringify({
            first_name: $("#form-edit #edit-input-forename").val(),
            last_name: $("#form-edit #edit-input-surname").val(),
            dob: $("#form-edit #edit-input-dob").val(),
            sex: $("#form-edit #edit-select-gender option:selected").val(),
    ...
    $("#display-btn-play").click(function() {
        if(selected != null && selected_data != null) {
            loading_menu();
            $.post('http://rp-core/Select.Character', JSON.stringify({
                character: selected_data,
            }));        
        }
    });
    ...
    $("#display-btn-edit").click(function() {
        if(selected != null && selected_data != null) {
            ...
            $("#form-edit #edit-select-gender option:selected").val(selected_data.sex).trigger("change")
            edit_menu();
        }
    });
    ...
    $("#delete-icon-accept").click(function(){
        loading_menu();
        $.post('http://rp-core/Delete.Character', JSON.stringify({
            character: selected_data,
        }));
    });
